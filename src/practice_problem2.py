...
def run_test_practice_problem2a():
    ...
    expected = [2,8,7,3,4]
    actual = practice_problem2a([3,9,8,4,5], -1)
    print('expected:', expected )
    print('actual:', actual)

    expected = [1,2,3,4,5]
    actual = practice_problem2a([1,2,3,4,5], 0)
    print('expected:', expected )
    print('actual:', actual)

    expected = [1,0,-1,-1,6]
    actual = practice_problem2a([-1,-2,-3,-3,4], 2)
    print('expected:', expected )
    print('actual:', actual)
